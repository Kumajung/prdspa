...
<body>
                ...
                <form id="frm" method="POST">
                    <div class="card">
                        <div class="card-header">
                            <i class="fa-solid fa-list-check"></i> ส่วนจัดการลูกค้า
                        </div>
                        <div class="card-body">
                            ...
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="tel" class="form-control" id="phone" name="phone" placeholder="" autocomplete="off" required>
                                </div>
                            </div>
                            <div class="form-group row mb-3">
    ...
    <script>
        ...
        $('#frm').submit(async function(e) {
            ...
            const url = edit_id === '' ? 'api/customers/create.php' : 'api/customers/update.php';
        ...
        async function getCustomer() {
            try {
                let content = '';
                let num_c = 1;
                const response = await axios.get('api/customers/read.php');
        ...
        async function editService(id) {
            try {
                const {
                    data
                } = await axios.get('api/customers/read.php');
        ...
        function deleteService(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    try {
                        const response = await axios.delete('api/customers/delete.php', {
                            data: {
                                id: id
                            }
                        })
